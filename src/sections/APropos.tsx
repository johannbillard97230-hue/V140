      ...
      <div className="relative max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        >
          ...
          <div className="space-y-4 text-gray-600 leading-relaxed">
            ...
            <p>
              Depuis nos débuts, nous avons déjà accueilli des centaines de voyageurs, cumulé <strong className="text-gray-900">87 avis 5 étoiles sur 90 sur Google</strong>, et fait la preuve qu'un parking aéroport peut être à la fois économique et de qualité.
            </p>
          </div>
        </motion.div>
        ...
        >
          {[
            ...
            { value: '87', label: 'avis 5 étoiles Google' },
